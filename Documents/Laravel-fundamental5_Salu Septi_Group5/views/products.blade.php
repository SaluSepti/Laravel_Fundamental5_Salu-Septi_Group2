        ...
        <div class="rounded bg-info pt-3 pb-3">
            <div class="row">
                <div class="col-md-4 d-flex justify-content-start">
                    <a href="{{ route('admin_page', ['user' => 1]) }}"
                        class="btn btn-md btn-primary fw-bold ms-3 h-75 m-auto">Halaman Pengguna 1</a>
                </div>
                <div class="col-md-4">
                    <h2 class="text-center fw-bold mt-2">PRODUCTS</h2>
                </div>
                <div class="col-md-4 d-flex justify-content-end">
                    <a href="{{ route('admin_page', ['user' => 2]) }}"
                        class="btn btn-md btn-success fw-bold ms-3 h-75 mt-2 me-3">Halaman Pengguna 2</a>
                </div>
            </div>
